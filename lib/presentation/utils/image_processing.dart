...
abstract class ImageProcessing {
    ...
    static int _decodeYUV420SPtoRedBlueGreenSum(Uint8List yuv420sp, int width, int height, int type) {
     ...
     */
    static double decodeYUV420SPtoRedBlueGreenAvg(Uint8List yuv420sp, int width, int height, int type) {
        if (yuv420sp == null) return 0;
        final int frameSize = width * height;
